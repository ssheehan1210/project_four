			...
			<div className='container-fluid'>
				<div className='row'>
					<div className='col-12'>
						<h5>Introduction</h5>
						<p>Hello there! If you are reading this and are looking for a easy to follow tutorial to help you create your new character, then you've come to the right place!</p>
						<p><small>If not, then... well... uh... there's complementary free pizza in the back of the room, if you want any.</small></p><br/>
						<p>Now I know what you're thinking: 'Why would I need a tutorial when a lot of this stuff looks easy to fill in and/or I already have (a friend / an official guidebook / my imagination) to help me make my own character?' Well there are many answers I can give to that, especially to all you first-time role-players out there, but the biggest piece of advice I can give in regards to character creation is that there are times when there's a difference between characters you <strong>envision playing</strong> and characters you are <strong>currently capable/comfortable being</strong> while in-game.</p><br/>
